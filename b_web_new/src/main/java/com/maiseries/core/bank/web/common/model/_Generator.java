...
import com.maiseries.core.bank.web.common.BaseConfig;
...
public class _Generator {
	...
	public static void main(String[] args) {
		// base model 所使用的包名
		String baseModelPackageName = "com.maiseries.core.bank.web.common.model.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getWebRootPath()
				+ "/src/main/java/com/maiseries/core/bank/web/common/model/base";

		System.out.println("输出路径："+ baseModelOutputDir);

		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "com.maiseries.core.bank.web.common.model";
