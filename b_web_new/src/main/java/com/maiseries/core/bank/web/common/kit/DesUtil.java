...
public class DesUtil {
    ...
    /*public static void main(String[] args) {
        ...
        String key3 = "@@#$!==1";
        String data = "6D2B9051889C98FDF0FF9D96DE2F206BBBC4B37375004289"; 
        String str = desObj.strEnc(data,key3);
       System.out.println(str);
        String dec = desObj.strDec(str,key3);
     ...
     * return string
     */
    public final static String byteToString(int[] byteData) {
        String str = "";
        for (int i = 0; i < 4; i++) {
            int count = 0;
            for (int j = 0; j < 16; j++) {
    ...
    public final static int[] dec(int[] dataByte, int[] keyByte) {
        int[][] keys = generateKeys(keyByte);
        int[] ipByte = initPermute(dataByte);
        int[] ipLeft = new int[32];
        int[] ipRight = new int[32];
