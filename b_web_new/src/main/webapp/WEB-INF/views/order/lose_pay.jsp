...
<div class="warp">
	<div class="container">
		<div class="ui-content">
			...
			<div class="pay-ok">
				<h3><img src="${resource_dir}/images/reg_20_1.png" />
				   <c:if test="${Message==''||Message==null}">订单确认中...</c:if>
				   <c:if test="${Message!=''&&Message!=null}">支付失败 !</c:if>
				</h3>
				<div class="pay-lose-textcenter">
					<c:if test="${Message!=''&&Message!=null}">失败原因：${Message}</c:if>
