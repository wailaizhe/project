...
<html>
        ...
        function baseLogin(){
			...
			$("#btnLogin").attr("disabled","disabled");
			         $.ajax({
							...
							url:  '/checkLogin',
							data:{
								"userName":phone,"password":strEnc(mi1,'${key}'),"code":code
							},
    ...
    function changeImg(){    
	    var imgSrc = $("#imgObj");    
	    var src = "/authimg?codeType=loginCode&now="+Math.random();   
	    imgSrc.attr("src",src);    
	}
				...
				<div class="login">
					...
					<div class="ui-form-item " style="padding-top:10px; margin-bottom:5px;">
						<div class="ui-input-box" style="width:168px;">
							...
							<img id="imgObj" class="yzm" title="看不清?请点击" style="cursor: pointer; width:80px;height:36px;margin-top: -6px;" onclick="changeImg()" src="/authimg"/>   
					</div>
					...
					<div class="ui-form-item clear">
						...
						<p class="lg-form-other"  style="float: left;">
							还没有账号，请&nbsp;
							<a title="注册" href="/register" class="textlink">注册</a>
						</p>
