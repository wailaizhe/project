...
$(function(){
         ...
         if(data1=="03"||data1.length>20){
	          $(".nav2").html("<a href='${ctx}/baseInfo/login' class='login'>登&nbsp;&nbsp;录</a><a href='${ctx}/baseInfo/register'  class='reg'>注&nbsp;&nbsp;册</a>");
	      }else{
...
<div class="head">
	<div class="head_main1">
        ...
        <div class="nav_section">
        	<div class="nav">
                <ul>
                    <li ><a href="${ctx}/item/index">首&nbsp;&nbsp;&nbsp;页</a></li>
                    <li><a href="${ctx}/item/gotoInvestmentList">惠赚钱</a></li>
                    <li class="current"><a href="${ctx}/invest/gotoloanApply">惠贷款</a></li>
