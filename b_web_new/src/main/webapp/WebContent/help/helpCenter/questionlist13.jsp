       ...
       <br />
        ...
        <div class="centent-nr">
            ...
            <div class="zy-centent">
                <b class="the-end"></b>
                <div class="the-stept">
                    <span><b>1</b>点击导航“我的账户”，进入个人信息页面后点击“实名认证” </span>
                    <div>
                        <img width="100%" src="${resource_dir}/images/h7.jpg"></div>
                </div>
                <div class="the-stept">
                    <span><b>2</b>在弹出的下拉框，输入真实姓名和身份证号码 </span>
                    <div>
                        <img width="100%" src="${resource_dir}/images/h8.jpg"></div>
                </div>
                <div class="the-stept">
                    <span><b>3</b>实名认证完成后，可以看到真实姓名及隐藏的身份证号码 </span>
                    <div>
                        <img width="100%" src="${resource_dir}/images/h9.jpg"></div>
                </div>
            </div>
        </div>
        <br />
