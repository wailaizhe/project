<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
<%@ include file="/WebContent/common/taglib.jsp"%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<script type="text/javascript">
    $(function () {
		...
		<br />
        <h3 class="r_title">注册登录指引</h3>     
		<div class="centent-nr"> <br />
			<br />
			<div class="zy-centent"> <b class="the-end"></b>
				<div class="the-stept"> <span><b>1</b>在平台首页点击“免费注册”按钮，或者点击顶部的“注册”链接进入注册页面 </span>
					<div> <img width="100%" src="${resource_dir}/images/h23.jpg" s />
						<p> 可以在登录页面点击“注册”链接进入注册页面</p>
						<img width="100%" src="${resource_dir}/images/h24.jpg" /> </div>
				</div>
				<div class="the-stept"> <span><b>2</b>填写注册信息后，点击“免费注册” </span>
					<div> <img width="100%" src="${resource_dir}/images/h25.jpg" /></div>
				</div>
				<div class="the-stept"> <span><b>3</b>注册完成 </span>
					<div> <img width="100%" src="${resource_dir}/images/h26.jpg" /></div>
				</div>
			</div>
		</div>
		<br />
