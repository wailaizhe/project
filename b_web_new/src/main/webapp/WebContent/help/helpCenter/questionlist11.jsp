...
<div class="wrap wrap-960">
    	<div class="hpl">
        	...
        	<h3 class="wenicon">常见问题</h3>
               ...
               <!--
                <li>
                	 <a href="questionlist13.jsp">如何实名认证</a> 
                </li>
                -->
            </ul>
        </div>
    ...
    $(function () {
        ...
        <div class="centent-nr">
            ...
            <div class="zy-centent">
                <b class="the-end"></b>
                <div class="the-stept">
                    <span><b>1</b>在浏览器中打开中国银联官网：  http://corporate.unionpay.com/ </span>
                    <div>
                        <img width="100%" src="${resource_dir}/images/h01.jpg" /></div>
                </div>
                <div class="the-stept">
                    <span><b>2</b>注册开通银联账号：</span>
                    <div>
                        <img width="100%" src="${resource_dir}/images/h02.jpg" /></div>
                </div>
                <div class="the-stept">
                    <span><b>3</b>重新登录 点击 “我的银联”，进入“我的银联”页面 ，点击“立即添加”，开通银联卡号</span>
                    <div>
                        <img width="100%" src="${resource_dir}/images/h03.jpg" /></div>
                </div>
                <div class="the-stept">
                    <span><b>4</b>绑定开通银联支付通道</span>
                    <div>
                        <img width="100%" src="${resource_dir}/images/h04.jpg" /></div>
                </div>
                <div class="the-stept">
                    <span><b>5</b>返回平台重新绑定银行卡</span>
                </div>
            </div>
        </div>
        <br />
