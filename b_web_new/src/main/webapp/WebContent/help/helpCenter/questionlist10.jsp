...
<script type="text/javascript">
    $(function () {
        ...
        <br />
         <h3 class="r_title">如何添加银行卡</h3>
        <div class="centent-nr">
            <br />
            <p style="font-size: 16px;">
                <strong>添加银行卡方法一：</strong></p>
            <br />
            <div class="zy-centent">
                <b class="the-end"></b>
                <div class="the-stept">
                    <span><b>1</b>选择项目点击“马上投标” </span>
                    <div>
                        <img width="100%" src="${resource_dir}/images/h10.jpg" /></div>
                </div>
                <div class="the-stept">
                    <span><b>2</b>在“确认份额页面”点击“添加账户” </span>
                    <div>
                        <img width="100%" src="${resource_dir}/images/h11.jpg" /></div>
                </div>
                <div class="the-stept">
                    <span><b>3</b>填写帐号相关信息，点击“确认” </span>
                    <div>
                        <img width="100%" src="${resource_dir}/images/h12.jpg" /></div>
                </div>
            </div>
        </div>
        <div class="centent-nr">
            <br />
            <p style="font-size: 16px;">
                <strong>添加银行卡方法二：</strong></p>
            <br />
            <div class="zy-centent">
                <b class="the-end"></b>
                <div class="the-stept">
                    <span><b>1</b>进入“我的账户”，打开“我的银行卡”页面，后点击“添加账户”，可添加银行卡 </span>
                    <div>
                        <img width="100%" src="${resource_dir}/images/h16.jpg" /></div>
                </div>
            </div>
        </div>
        <br />
